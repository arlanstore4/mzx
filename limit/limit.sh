...
echo -e "$green.........................................................."$NC
echo -e "               Autoscript Mod By ( arlanstore )" | lolcat
...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/arlanstore4/izinvps/main/ip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mAUTOSCRIPT SUKSES..\e[0m"
        sleep 5
    else
    echo -e "\e[31mScript Anda Telah Expired !!\e[0m";
    echo -e "\e[31mTolong Renew Dengan Owner Script @mzx45\e[0m"
    exit 0
    fi
}
IZIN=$(curl https://raw.githubusercontent.com/arlanstore4/izinvps/main/ip | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
clear
CLNAME=$(curl https://raw.githubusercontent.com/arlanstore4/izinvps/main/ip | grep $MYIP | awk '{print $2}')
if [ $MYIP = $CLNAME ]; then
echo ""
fi
clear
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/arlanstore4/mzx/main/"
